...
if submit_btn:
    ...
    if is_contradictory:
        ...
        description = "哎呀！被系統抓到了吧！你嘴上說著想體驗心跳加速，但身體卻很誠實地不想虧錢😆。你很容易在投資時患得患失，在風險與保守之間反覆橫跳喔！"
        strategy = "💡 給你的專屬建議：適合 60% 穩健 ETF 打底，搭配 10% 的『盲盒停損實驗區』讓你解解饞就好！"
    elif risk_score >= 65:
        persona = "🔥 歐皇附體的『激進型獵人』"
        description = "大風大浪沒在怕！你享受抽盲盒的刺激感，投資上也偏愛高風險高報酬。你具備強大的心理素質，只要看準了就敢衝！"
        strategy = "💡 給你的專屬建議：適合攻擊型配置，但拜託！一定要留至少 10% 的現金當作『風險防火牆』啊！"
    else:
        persona = "🛡️ 穩如泰山的『佛系收藏家』"
        description = "拒絕當韭菜的最佳代表！你喜歡確定的事物，買東西不靠運氣，投資也愛穩穩拿配息。是個超級理性、不容易被市場恐慌情緒煽動的狠角色！"
        strategy = "💡 給你的專屬建議：你超適合 70% 穩定配息 ETF 加上大型藍籌股定期定額，靠時間魔法穩穩把錢養大！"
